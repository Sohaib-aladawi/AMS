...
<body>
  ...
  <!--  -->
  <section id="features">
    <form action="" method="POST" form="formPreadvice">
      <div>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <h4 class="text">Specialization: <span class="text-white">{{ $specialization->specialization_name }}</span></h4>
        </div>
        <div class="col-md-3">
          <h4 class="text">Level: <span class="text-white">Diploma 2</span></h4>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-5">
          <h4 class="text">
            Number of courses studying now: <span class="text-white"> 0</span>
          </h4>
        </div>
        <div class="col-md-3">
          <h4 class="text">Status: <span class="text-white">Studying</span></h4>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
        ...
        <table class="table table-bordered border-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input class="form-check-input" type="checkbox" value="study" id="flexCheckDefault" />
              </td>
            </tr>
            @php
                $c=$c+1;  
    ...
    <!-- Button Submit -->
    <button type="button" class="btn btn-warning align-right" form="formPreadvice">Save</button>
    <a href="../Dashbord/homePage.html"><button type="button" class="btn btn-white align-right" type="button">
        Back
      </button></a>
  </section>

  <section id="copyright">
    <a href="../Dashbord/homePage.html">
